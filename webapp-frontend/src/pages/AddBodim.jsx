...
const AppartmentDetails = () => {
  ...
  const contactNumberValidation = (name, value) => {
    ...
    setBodimDetails({
      ...BodimDetails,
      contact: [...BodimDetails.contact, value],
    });
  ...
  return (
    <Container sx={{ backgroundColor: "#FFFFFF", paddingTop: "5px" }}>
      <Grid container spacing={2}>
        <Grid item md={6}>
          <Box sx={boxStyle}>
            <FormLabel sx={labelWidthStyle} htmlFor="bodimName">
              Enter appartment name
            </FormLabel>
            <TextField
              maxLength={10}
              error={BodimDetailsError.bodimNameError}
              required
              onChange={handleChange}
              value={BodimDetails.bodimName}
              sx={feildWidthStyle}
              name="bodimName"
              id="bodimName"
              label="bodim Name"
        ...
        <Grid item md>
          <Box sx={boxStyle}>
            ...
            <FormControl sx={{ minWidth: "50%" }} size="small" minwidth="48rem">
              <Select
                error={BodimDetailsError.bodimTypeError}
                required
                defaultValue={"none"}
                name="bodimType"
                onChange={handleChange}
      ...
      <Grid container spacing={2}>
        <Grid item md>
          <Box sx={boxStyle}>
            <FormLabel sx={labelWidthStyle} htmlFor="price">
              Price
            </FormLabel>
            <TextField
        ...
        <Grid item md>
          <Box sx={boxStyle}>
            <FormLabel sx={labelWidthStyle} htmlFor="contact">
              Contact details
            </FormLabel>
            <TextField
      ...
      <Grid container spacing={2}>
        <Grid item md>
          <Box sx={boxStyle}>
            <FormLabel sx={labelWidthStyle} htmlFor="distance">
              Distance to Uni
            </FormLabel>
            <TextField
      ...
      <pre>{JSON.stringify(BodimDetails)}</pre>
    </Container>
  );
};
            ...
            {availableFeatures.map((feature, index) => (
              <Box key={index} display="flex" alignItems="center" mb={2}>
                ...
                <TextField
                  ...
                  value={feature.count}
                  onChange={(e) =>
                    updateFeatureCount(index, parseInt(e.target.value))
                  }
                  sx={{ ml: 1, mr: 1 }}
                  size="small"
                />
